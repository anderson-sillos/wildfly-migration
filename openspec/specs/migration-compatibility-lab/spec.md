# Laboratório de compatibilidade da migração

## Purpose

Define o roteiro incremental, os checkpoints e os gates usados para demonstrar a compatibilidade durante a migração.
