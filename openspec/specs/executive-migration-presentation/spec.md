# Executive Migration Presentation Specification

## Purpose

Definir a narrativa, a rastreabilidade e os critérios editoriais da apresentação executiva do laboratório de migração Java/WildFly.
