...
- [ ] 3.10 Encerrar `CP-3B`: executar contratos e auditoria depois das atualizações, registrar evidências e rollback e integrar o PR pelo commit `checkpoint(CP-3B): modernize core dependencies`.
