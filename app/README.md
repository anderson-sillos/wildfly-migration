...
Enquanto somente a tarefa 2.11 está aplicada, o wrapper ainda exige Maven
3.8.9 executando no Temurin OpenJDK 8u492-b09, compila bytecode major `52` e
audita o WAR. O build usa o Jakarta EE Web Profile 8 em `provided`, cujas APIs
ainda permanecem em pacotes `javax.*`. A troca para Maven 3.9.16 ocorre na
tarefa 2.12. Para reproduzir o build Java 7, materialize a tag da fase 1 e siga
o runbook congelado.
